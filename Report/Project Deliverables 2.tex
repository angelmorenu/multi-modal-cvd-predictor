...
% --- Figure 1: two-column architecture (robust path checks including ui/) ---
\begin{figure*}[!t]
    \centering
    % Check for PDF/PNG in figures/, then ui/, then project root; fallback to message box.
                ...
                \IfFileExists{\detokenize{ui/multimodal_cvd_architecture.png}}{%
                    ...
                    \IfFileExists{\detokenize{multimodal_cvd_architecture.pdf}}{%
                        ...
                        \IfFileExists{\detokenize{multimodal_cvd_architecture.png}}{%
                            ...
                            \fbox{%
                                \parbox[b][5cm][c]{0.92\textwidth}{\centering Architecture figure not found\\(expected: figures/ or ui/ or project-root: multimodal\_cvd\_architecture.pdf/png).}%
                            }%
                        }%
                    }%
                }%
...
\begin{table}[!t]
    ...
    \centering
    \caption{Preliminary Evaluation Metrics on Held-Out Test Set}
    \label{tab:metrics}
    \begin{tabular}{@{}lcc@{}}
        \toprule

...
\textbf{Open Science:}
\begin{itemize}
    \item Code, documentation, and non-sensitive artifacts are version-controlled and publicly available on GitHub (\texttt{github.com/angelmorenu/multi-modal-cvd-predictor}).
